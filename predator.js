(function () {
    ...
    showFloatingText = 'floatingRight',
        fpsValue = 60,
        animationPath = 'https://cdn.nerdordie.com/Alerts/Predator/predator-' + alertType + '-' + fpsValue +  '.json';
    ...
    loadScript('https://cdnjs.cloudflare.com/ajax/libs/gsap/2.1.1/TweenMax.min.js').then(function () {
        loadScript('https://cdn.nerdordie.com/Alerts/Predator/predator-bm.js').then(function () {
    ...
    var animate = function() {
        ...
        tl.to(alertContainer, .1, {autoAlpha: 1, delay: .2})
